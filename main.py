...
def main():
    ...
    if choice == "Principal":
        st.markdown(
            "<h4 style='color:white;'>Aplicación web de detección de __________ usando Yolo__, Google Colab, Roboflow, Streamlit y lenguaje de programación Python.</h4><br>",
            unsafe_allow_html=True,
        )
        ...
        if image:
            ...
            col1.image(
                image, caption="Imagen original"
            )  # Ajusta el uso del ancho de la columna
            if model:
                with col2:
